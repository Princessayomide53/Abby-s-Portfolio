...
const Projects: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden bg-[#2B1851]">
      ...
      >
        <div className="h-[13rem] md:h-[22rem] lg:h-[29.5rem] flex flex-col justify-center items-center w-full border-b-4 border-white">
        ...
        <div className="h-[13rem] md:h-[22rem] lg:h-[29.5rem] flex flex-col justify-center items-center w-full border-b-4 border-white">
          <div className="flex gap-5">
            ...
            <Image
              ...
              priority
            />
            {/* <h2 className="text-white text-[50.1px] font-extrabold leading-[20.049px]">
              QuickFill
            </h2> */}
          </div>
