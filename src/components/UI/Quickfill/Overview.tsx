...
const Overview = () => {
  return (
    <section className=''>
      <article className=' xl:max-w-[72rem] mt-5 pro:max-w-[52rem] md:max-w-[45rem] max-w-[22rem] mac:max-w-[83rem] lg:max-w-[59rem] mx-auto rounded-2xl w-full h-[22.3125rem] p-10'>
